...
_KEYBIND_SET={
    ...
    INSTANT_GRAB_KEYBIND=true,DROP_BRAINROT_KEYBIND=true,
    ...
    local function setupFloatingPanels()
        ...
        do
            ...
            startCounterBatWatcher=function()
                if _counterBatConn then return end
    ...
    local function createDuelTab(parent)
        ...
        resetBtn.MouseButton1Click:Connect(function()
            ...
            local defaults={
                ...
                INSTANT_GRAB_ACTIVATION_DIST=8,FOV_VALUE=70,
