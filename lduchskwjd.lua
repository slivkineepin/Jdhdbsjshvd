        ...
        do
            ...
            local function _startMirrorWatcher()
                ...
                _mirrorConn=RunService.Heartbeat:Connect(function()
                    ...
                    if _mirrorCooldown then return end
                            ...
                            if hrp then
                                ...
                                if lastY then
                                    ...
                                    if drop>=(CONFIG.MIRROR_TP_DOWN_THRESHOLD or 8) then
                                        _mirrorCooldown=true
                                        tpDown()
                                        task.delay(1,function()_mirrorCooldown=false end)
                                        _prevY={}
                                        return
                                    end
                                end
